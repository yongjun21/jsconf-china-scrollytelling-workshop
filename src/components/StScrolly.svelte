<div class="st-scrolly" class:active>
  <div class="background-container">
    <div class="background" style={stickyStyle}>
      <slot name="background" slideIndex={exposedScope.slideIndex} enter={exposedScope.enter}></slot>
    </div>
  </div>

  <div class="slide-container" bind:this={slidesRef}>
    <slot slideIndex={exposedScope.slideIndex} enter={exposedScope.enter}>
      <div class="slide"></div>
    </slot>
  </div>
